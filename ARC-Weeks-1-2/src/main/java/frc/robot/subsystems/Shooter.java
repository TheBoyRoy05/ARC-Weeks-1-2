...
public class Shooter extends SubsystemBase {
  ...
  private final WPI_TalonSRX leftFlywheel;
  private final WPI_TalonSRX rightFlywheel;
  ...
  private SimpleMotorFeedforward rightFlywheelFF;
  ...
  public Shooter() {
    leftFlywheel = new WPI_TalonSRX(Constants.ShooterPorts.LeftFlywheelPort);
    rightFlywheel = new WPI_TalonSRX(Constants.ShooterPorts.RightFlywheelPort);
    leftFlywheelPID = new PIDController(Constants.leftFlywheelPIDConsts.pidP, Constants.leftFlywheelPIDConsts.pidI, Constants.leftFlywheelPIDConsts.pidD);
    rightFlywheelPID = new PIDController(Constants.rightFlywheelPIDConsts.pidP, Constants.rightFlywheelPIDConsts.pidI, Constants.rightFlywheelPIDConsts.pidD);
    ...
    rightFlywheelFF = new SimpleMotorFeedforward(Constants.rightFlywheelFF.kS, Constants.rightFlywheelFF.kV, Constants.rightFlywheelFF.kA);
